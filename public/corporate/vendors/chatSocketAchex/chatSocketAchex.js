$.fn.extend({ChatSocket: function(opciones) {
         ...
         $('#'+idOnline).append(' <div class="my_success_list_chat_1 panel panel-'+panelColor+'"><div class="panel-heading"><span class="glyphicon glyphicon-user"></span> '+lblUsuariosOnline+'</div><div class="panel-body"><ul class="list-group" id="listaOnline"></ul></div></div>');
