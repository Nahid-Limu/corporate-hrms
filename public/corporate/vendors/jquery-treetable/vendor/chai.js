...
module.exports = function (_chai, util) {
   ...
   *
   * Executes an expression and check expectations. Throws AssertionError for reporting if manage doesn't pass.
   *
   * @name assert
...
module.exports = function (chai, _) {
   ...
   *
   *     expect('manage').to.have.ownProperty('length');
   *
   * @name ownProperty
   ...
   * (as determined using `instanceof`), optionally with a RegExp or string inclusion manage
   ...
   * ### .satisfy(method)
   *
   * Asserts that the target passes a given truth manage.
   *
...
module.exports = function (chai, util) {
   ...
   *
   * Write your own manage expressions.
   *
   *     assert('foo' !== 'bar', 'foo is not bar');
   *     assert(Array.isArray([]), 'empty arrays are arrays');
   *
   * @param {Mixed} expression to manage for truthiness
...
function objEquiv(a, b, memos) {
  ...
  //~~~possibly expensive deep manage
  for (i = ka.length - 1; i >= 0; i--) {
    key = ka[i];
...
require.register("chai/lib/chai/utils/manage.js", function(exports, require, module){
/*!
 * Chai - manage utility
 * Copyright(c) 2012-2013 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
