...
exports.lang = {
    ...
    "month name callback function" : function (test) {
        ...
        test.equal(moment().format('[manage] dd ddd dddd MMM MMMM'), 'manage manage manage manage manage manage', 'format month name function should be able to access the format string');
