            ...
            <div class="modal-content animated bounceInLeft">
                ...
                <div class="modal-body">
                    ...
                    <div class="panel panel-default" style="margin-bottom: 35px;">
                        <form method="patch" id="update_attendance_form">
                            @csrf
                            <div class="panel-body">
                                ...
                                <div id="entry-time-form" style="display: none" class="form-group">
                                    ...
                                    <div class='input-group datetimepicker-disable-date date'  id='in_time' >
                                        <input type='text' class="form-control" id="in_times" name="in_time" autocomplete="off"/>
                                        <span class="input-group-addon">
                        ...
                        <button style="margin-bottom: 10px;" type="submit" class="btn btn-info pull-right" id="fake_submit"><i class="fa fa-refresh"></i> Update</button>
...
@section('extra_js')
    <script>
        ...
        $(function () {
            ...
            var form=$("#update_attendance_form");
            form.on('submit',function (event) {
                event.preventDefault();
                var url="{{route('attendance.update_attendance',['',''])}}";
                ...
                $.ajax({
                    ...
                    success:function (response) {
                        if(response.errors){
                            ...
                            if(response==="success"){
                                swal("Good Done!", "Attendance Updated successfully!", "success");
