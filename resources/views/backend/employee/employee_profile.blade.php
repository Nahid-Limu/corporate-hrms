                                       ...
                                       <div class="row pb-r">
                                           ...
                                           <div class="col-md-6">
                                               <div class="form-group">
                                                   ...
                                                   <div class="col-md-7 col-sm-8 col-xs-7">
                                                       <p class="form-control-static">{{date('d/m/Y',strtotime($employee_profile->emp_joining_date))}} &nbsp</p>
                                                   </div>
                                               </div>
                                           </div>
                                           ...
                                           <div class="col-md-6">
                                               <div class="form-group">
                                                   ...
                                                   <div class="col-md-7 col-sm-8 col-xs-7">
                                                       <p class="form-control-static">{{date('d/m/Y',strtotime($employee_profile->emp_dob))}} &nbsp</p>
                                                   </div>
                                               </div>
                                           </div>
                                           ...
                                           <div class="col-md-6">
                                               <div class="form-group">
                                                   ...
                                                   <div class="col-md-7 col-sm-8 col-xs-7">
                                                       <p class="form-control-static">{{$employee_profile->shift_name}}[{{ date('h:i A', strtotime($employee_profile->entry_time))}} - {{ date('h:i A', strtotime($employee_profile->exit_time))}}] &nbsp</p>
                                                   </div>
                                               </div>
                                           </div>
                                   ...
                                   <div class="col-md-12">
                                       <div class="table-responsive">
                                        @if(!$current_salary->isEmpty())
                                           ...
                                           @else
                                           <h5 class="not_found_data">Not found</h5>
                                           @endif
                                       </div>
                                   </div>
                               </div>
