                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-blue">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="hidden" id="employee_id" name="employee_id" value="{{auth()->user()->emp_id}}">
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12"  style="margin-top: 10px;">
                                        <button type="submit" id="assign_btn" class="btn btn-md btn-round btn-success pull-left" style=""><i class="fa fa-check"></i>Apply Leave</button>
                                    </div>
                                </div>
                                </form>
                            </div>
