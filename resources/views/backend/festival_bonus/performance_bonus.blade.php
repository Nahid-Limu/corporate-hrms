...
@section('content')
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title">Performance Bonus</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{url('/')}}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><a href="#">Performance Bonus</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        </ol>
                        ...
                        <form class="form-group" method="post" action="{{route('save_festival_bonus')}}" novalidate>
                            ...
                            <div class="col-md-2" id="percent_div" style="display: none">
                              ...
                              <div class="col-md-12">
                                ...
                                <input type="hidden" name="bonus_type" id="bonus_type" value="1">
