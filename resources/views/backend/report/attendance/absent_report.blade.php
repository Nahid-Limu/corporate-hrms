            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="panel panel-blue">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method'=>'post','action'=>'AttendanceReportController@daily_absent_report_data']) !!}

                        <div class="col-md-10 col-md-offset-1 ex-form">

                            <div class="form-group">
                                <div class="input-form-gap"></div>
                                <label class="col-md-4">Date <span class='require'>*</span> <span class="clon">:</span></label>
                                <div class="col-md-8">
