...
@section('content')
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title">Daily Absent Report</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{url('/')}}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><a href="#">Report</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li class="active">Daily Absent Report</li>
        </ol>
            ...
            <div class="col-lg-12">
                <div class="panel panel-blue">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                Absent Report for {{\Carbon\Carbon::parse($request->date)->format('j M Y')}}
                            </div>
                            {!! Form::open(['target'=>'_blank','method'=>'post','action'=>'AttendanceReportController@daily_absent_report_export']) !!}
    ...
    <script>
        $(document).ready(function(){
            $('#daily_attendance_report_table').DataTable({
                ...
                "order": [[ 0, "desc" ]],
                ajax:{
                    url: "{{ route('attendance.daily_absent_report_data') }}",
                    type:"post",
                    data:{
                        "_token": "{{ csrf_token() }}",
                        'date':"{{$request->date}}",
                ...
                columns:[
                    ...
                    // },
                    {
                        ...
                        render:function (data,type,row) {
                            return "<span style='font-weight: bold; color: darkred'>Absent</span>";
