...
<div>
    <table>
        ...
        <tr><td></td><td colspan="5" style="text-align: center">Late Report From<b>{{\Carbon\Carbon::parse($request->date)->format('d M Y')}} </b> to <b>{{\Carbon\Carbon::parse($request->end_date)->format('d M Y')}} </b></td></tr>
