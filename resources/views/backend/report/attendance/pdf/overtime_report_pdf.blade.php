    ...
    <table class="table1">
        ...
        <tr style="text-align:center;">
            <td style="text-align:center;" colspan="2">
                <h6 style="margin-top:10px;font-size:16px;">Overtime Report From {{\Carbon\Carbon::parse($request->date)->format('d M Y')}} to {{\Carbon\Carbon::parse($request->end_date)->format('d M Y')}}</h6>
            </td>
        </tr>
