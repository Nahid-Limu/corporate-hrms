...
@section('title', 'Present Report Data')
@section('content')
    <!--BEGIN TITLE & BREADCRUMB PAGE-->
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title">Present Report</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{url('/')}}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><a href="#">Report</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li class="active">Present Report</li>
        </ol>
            ...
            <div class="col-lg-12">
                <div class="panel panel-blue">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                Present Report From {{\Carbon\Carbon::parse($request->date)->format('j M Y')}} to {{\Carbon\Carbon::parse($request->end_date)->format('j M Y')}}
                            </div>
                            {!! Form::open(['target'=>'_blank','method'=>'post','action'=>'AttendanceReportController@present_report_export']) !!}
    ...
    <script>
        $(document).ready(function(){
            $('#daily_attendance_report_table').DataTable({
                ...
                "order": [[ 0, "desc" ]],
                ajax:{
                    url: "{{ route('attendance.present_report_data') }}",
                    type:"post",
                    data:{
                        "_token": "{{ csrf_token() }}",
                        'date':"{{$request->date}}",
