...
@section('content')
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li><a href="#">Branch Wise Employee</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li class="active">Branch Wise Employee</li>
        </ol>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                        <div class="panel panel-blue">
                          ...
                          {!! Form::open(['method'=>'post','url'=>'report/client/list/preview/download']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <button type="submit" name="pdf" value="pdf" class="btn btn-success">
                                                <i class="fa fa-file"></i> Generate PDF</button>
                                        </div>
                                    </div>
                                </div>
                              {!! Form::close() !!}
