...
@section('content')
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title">Low Priority Project</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{url('/')}}">Home</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li><a href="#">Manage Report</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
            <li class="active">Low Priority Project</li>
        </ol>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                        <div class="panel panel-blue">
                          ...
                          {!! Form::open(['method'=>'post','url'=>'report/branch/project/low/show']) !!}
                                ...
                                <div class="col-md-10 col-md-offset-1 ex-form">
                                    ...
                                    <div class="form-group">
                                        <div class="input-form-gap"></div>
                                        <label for="project_prioritylow_id" class="col-md-4">Select Low Priority Project<span class="clon">:</span></label>
                                        <div class="col-md-8">
                                            <select name="project_id" id="project_prioritylow_id"  class="select2-container form-control" required>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#branch_id').on('change',function () {
                ...
                $.ajax({
                    type: "GET",
                    url:"{{url('ajax/get_low_project/')}}"+"/"+id,
                    success:function (response) {
                        console.log(response);
                        var project_list = '';
                        ...
                        $('#project_prioritylow_id').html(project_list);
        ...
        $("#project_prioritylow_id").select2({
