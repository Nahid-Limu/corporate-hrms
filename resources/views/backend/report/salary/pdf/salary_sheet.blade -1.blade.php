...
<head>
  <style>
    @page { 
        margin-top: 90px;margin-bottom:70px;size: landscape;
    ...
    .custom_table td, .custom_table th,.custom_table tr {
        border: 1px solid #000;
        padding: 3px 1px;
    }
    tbody tr td{
    ...
    tr    { page-break-inside:avoid; page-break-after:auto; border-bottom: 1px solid red;}
...
<body>
  ...
  <main>
    ...
    <table class="custom_table" style="text-align:center;">
            
        <thead class="table_head">
            

            <tr class="heading-top header-space-tr">
                <th colspan="1" class="header-space-th">
                   
                            <div class="header-space">&nbsp;</div>
                      
                </th>
                <th colspan="5" style="text-align:center">Section: FACTORY STAFF </th>
                <th colspan="5" style="text-align:center"></th>
                <th colspan="5" style="text-align:center">Block</th>
                <th colspan="5" style="text-align:center">Page Number: 1/2</th>
            </tr>
            
            
            <tr class="heading-top-middle">
                <th  rowspan="2">SI 1 No</th>
                ...
                <th rowspan="2"> &nbsp; &nbsp; Signature  <span class="signature_ex">value</span> </th>
        ...
        <tfoot>
                <tr class="heading-bottom" style="border:0px; font-size:11px;padding-top: 30px;">
                        ...
                        <td colspan="7" style="text-align:center">Checked By</td>
                        <td colspan="7" style="text-align:center">Manager Account</td>
                        <td colspan="8" style="text-align:center">Managing Director</td>
                </tr>
        </tfoot>
