...
<body>
  <div class="wrapper">
      ...
      <table class="table2 table-bordered"  style="width:100%" >
	   ...
	   <h4 style="text-align:center">Assign Member</h4>
	       <table class="table2 table-bordered"  style="width:100%" >
          <tr style="text-align:center;">
                 <th>Training</th>
                 <th>Employee Id</th>
           ...
           @foreach($assign_training as $a_training)
                <tr>
                    <td>{{$a_training->training_name}}</td>
                    <td>{{$a_training->employeeId}}</td>
                    <td>{{$a_training->emp_first_name}} {{$a_training->emp_lastName}}</td>
            @endforeach
      </table>
  </div>
</body>
